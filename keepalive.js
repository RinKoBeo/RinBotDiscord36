// ticket.js - He thong ticket tu dong bang nut bam (FIX LOI UNDEFINED)
...
async function sendTicketPanel(client) {
  try {
    ...
    // ✅ SỬA: Embed cho panel KHÔNG dùng ticketId (vì đây là panel chính)
...
async function handleCreateTicket(interaction) {
  ...
  // ✅ SỬA: Embed này dùng ticketId và userId đã có trong scope
  const embed = new EmbedBuilder()
