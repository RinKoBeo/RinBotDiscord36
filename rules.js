...
function buildRulesEmbed() {
  const embed = new EmbedBuilder()
    ...
    .setColor(0x8b0000)
    .setDescription('Luật Discord giúp tạo ra môi trường cộng đồng an toàn, tôn trọng và có trật tự. Vui lòng đọc kỹ và tuân thủ các quy định dưới đây:')
    .setFooter({
      text: 'Vi phạm luật có thể dẫn đến cảnh cáo (warn), timeout, kick hoặc ban tuỳ mức độ, theo quyết định của Moderator.',
    })
    .setTimestamp();
